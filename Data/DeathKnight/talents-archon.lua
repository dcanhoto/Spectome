-- Data/DeathKnight/talents-archon.lua
-- Blood talent data sourced from Archon. Curated manually by the addon
...
Spectome.Data.DeathKnight.Blood.talents.archon = {
	source = "archon",
	class = "DeathKnight",
	spec = "Blood",
	...
	builds = {
		{
			context = "raid",
			heroTalent = "San'layn",
			loadoutString = "CoPAAAAAAAAAAAAAAAAAAAAAAwYWGzMmxMjhZbmZmmZxMjxMmBAAAAmZmZmZmZYGjBAjZmZGAAADMwMW0YZDw2A2AMjZAAAzMwwA",
			notes = "",
		},
		{
			context = "mythicPlus",
			heroTalent = "San'layn",
			loadoutString = "CoPAAAAAAAAAAAAAAAAAAAAAAwMzyMzwMmZmhZbmZmmZxMjZmBAAAAwMMzMzMjZGDAYmZmZGAAADMwMW0YZDw2A2AMjBAAYmBDGA",
			notes = "",
		},
	},
}
