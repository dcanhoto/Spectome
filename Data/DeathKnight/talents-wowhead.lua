-- Data/DeathKnight/talents-wowhead.lua
-- Blood talent data sourced from Wowhead. Curated manually by the addon
...
Spectome.Data.DeathKnight.Blood.talents.wowhead = {
	source = "wowhead",
	class = "DeathKnight",
	spec = "Blood",
	...
	builds = {
		{
			context = "raid",
			heroTalent = "San'layn",
			loadoutString = "CoPAAAAAAAAAAAAAAAAAAAAAAwYWmZmxMmZmhZZmZmmZxYMmxAAAAAmZmZmZmZYGjZAYMzMzAAAYgBmxiGLLgsMgNAzwAAAmZghB",
			notes = "",
		},
		{
			context = "mythicPlus",
			heroTalent = "San'layn",
			loadoutString = "CoPAAAAAAAAAAAAAAAAAAAAAAwYWmZmxMmZmhZZmZmmZxYMmxAAAAAmxMzMzMDzYMAYMzMzAAAYgBmxiGLLgsMgNAzYmBAAmZghB",
			notes = "",
		},
	},
}
