-- Data/Shaman/talents-archon.lua
-- Restoration talent data sourced from Archon. Curated manually by the
...
Spectome.Data.Shaman.Restoration.talents.archon = {
	source = "archon",
	class = "Shaman",
	spec = "Restoration",
	...
	builds = {
		{
			context = "raid",
			heroTalent = "Totemic",
			loadoutString = "CgQAAAAAAAAAAAAAAAAAAAAAAAAAAgBAAAAzMzsssNjZGjZGzMDjFYDmxiGbDgZgNzwMYbMmpZbZmZzMmFWMPwMjZYWGAAAYmZwMDAMYG",
			notes = "",
		},
		{
			context = "mythicPlus",
			heroTalent = "Totemic",
			loadoutString = "CgQAAAAAAAAAAAAAAAAAAAAAAAAAAgBAAAAzMzsstMzMzMjZGjZgFYDmxiGbDgZgNmZGMbPwMGNbLzMbmxsxixMjZsMLDAAAMzMYmBAGMD",
			notes = "",
		},
	},
}
