-- Data/Shaman/trinkets-icyveins.lua
-- Restoration trinket tier list sourced from Icy Veins. Curated manually by
...
-- Icy Veins for this spec). itemID = 0 is the same "no data yet"
...
Spectome.Data.Shaman.Restoration.trinkets.icyveins = {
	source = "icyveins",
	class = "Shaman",
	spec = "Restoration",
	...
	trinkets = {
		...
		{ tier = "B", itemID = 250254, notes = "" },
		{ tier = "C", itemID = 250248, notes = "" },
		{ tier = "C", itemID = 273649, notes = "" },
		{ tier = "C", itemID = 241291, notes = "" },
		{ tier = "C", itemID = 251788, notes = "" },
		{ tier = "C", itemID = 251789, notes = "" },
	},
}
